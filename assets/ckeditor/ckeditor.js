...
(function () {
				...
				on: function (b, d, f, l, h) {
					...
					if (0 > e.getListenerIndex(d)) {
						...
						for (var w = e.length - 1; 0 <= w; w--)
							if (e[w].priority <= h)
								return e.splice(w + 1, 0, k), { removeListener: p };
						e.unshift(k);
					}
						...
						if (e) {
							...
							if (w.length)
								for (var w = w.slice(0), y, G = 0; G < w.length; G++) {
									if (e.errorProof)
										try {
											y = w[G].call(this, p, k, b, l);
										} catch (q) {}
									else y = w[G].call(this, p, k, b, l);
	...
	(function () {
		function a(a, w, b) {
			...
			this.input = function () {
				...
				if (!e._scheduledTimer || !1 !== e._reschedule()) {
					...
					z < e._minInterval
						? (e._scheduledTimer = setTimeout(a, e._minInterval - z))
						: a();
				}
			};
		}
		...
		CKEDITOR.tools = {
			...
			parseCssText: function (a, b, e) {
				...
				a.replace(/&quot;/g, '"').replace(
					...
					function (a, e, z) {
						b &&
							((e = e.toLowerCase()),
							"font-family" == e && (z = z.replace(/\s*,\s*/g, ",")),
			...
			keystrokeToArray: function (a, b) {
				...
				c &&
					(a[c]
						? (n.push(a[c]), k.push(a[c]))
						: (n.push(String.fromCharCode(c)), k.push(String.fromCharCode(c))));
	...
	(function () {
		...
		function c(a) {
			for (var b = 0, c = 0, e = l[a].length; c < e; c++)
		...
		CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
			...
			getDocumentPosition: function (a) {
				...
				if (
					...
					var g = this.$.getBoundingClientRect(),
						...
						H = !0;
					CKEDITOR.env.ie &&
						((H = e.getDocumentElement().contains(this)),
					...
					H &&
						...
						(CKEDITOR.env.ie && 12 <= CKEDITOR.env.version)
							...
							: ((c = f ? d.$ : l), (b = c.scrollLeft), (c = c.scrollTop)),
						(b = g.left + b - n),
						(c = g.top + c - q));
				} else
					for (
			...
			scrollIntoParent: function (a, b, c) {
				...
				a instanceof CKEDITOR.dom.window &&
					(a = H ? f.getBody() : f.getDocumentElement());
				CKEDITOR.env.webkit &&
					(f = this.getEditor(!1)) &&
						...
						? e.type == CKEDITOR.NODE_ELEMENT &&
						  (e =
								0 < g
									...
									: !1 === h(e, !0)
									? null
									: e.getPreviousSourceNode(!0, m, h))
						: ((e = d),
						  e.type == CKEDITOR.NODE_ELEMENT &&
								((e = e.getChild(f)) ||
									(e =
										!1 === h(d, !0) ? null : d.getNextSourceNode(!0, m, h)))),
				  e && !1 === h(e) && (e = null));
			for (; e && !this._.end; ) {
				this.current = e;
	...
	(function () {
		...
		function d(a, b, c, d, f) {
			...
			if (
				...
				(m.equals(F) ||
					(m.type === CKEDITOR.NODE_ELEMENT && m.getFirst().equals(F)))
			)
				c.append(a.document.createText(F.substring(M, A)));
			else {
				F.type == CKEDITOR.NODE_TEXT
					? k
						? (S = !0)
				...
				for (
					...
					L = ba.getNext();
					for (
						U != J || (ba.equals(t[U]) && J < v)
							? b && (C = B.append(ba.clone(0, f)))
							: N
							? g(ba, B, !1, E)
							: u && B.append(a.document.createText(ba.substring(M)));
						L;
				...
				B = c;
				for (U = P; U <= v; U++)
					if (((c = t[U]), (L = c.getPrevious()), c.equals(T[U])))
						b && (B = B.getChild(0));
					else {
						U != v || (c.equals(T[U]) && v < J)
							? b && (C = B.append(c.clone(0, f)))
							: r
							? g(c, B, !1, D)
							: S && B.append(a.document.createText(c.substring(0, A)));
						if (U > da) for (; L; ) L = g(L, B, !0);
						B = C;
					}
				k || h();
			}
			...
			enlarge: function (a, b) {
				...
				switch (a) {
					...
					case CKEDITOR.ENLARGE_ELEMENT:
						...
						for (k = c(k); k || m; ) {
							if (k && !m) {
								...
								(M && "inline" == k.getComputedStyle("display")) ||
									((M = !1), F ? (l = k) : this.setStartBefore(k));
								m = k.getPrevious();
							}
							for (; m; )
									...
									if (m.type == CKEDITOR.NODE_TEXT)
										...
										if (M && CKEDITOR.dtd.$removeEmpty[m.getName()]) {
											...
											if (d.test(N)) m = null;
												...
												for (
													var r = m.$.getElementsByTagName("*"), E = 0, D;
													(D = r[E++]);

												)
													if (
														!CKEDITOR.dtd.$removeEmpty[D.nodeName.toLowerCase()]
													) {
														m = null;
														break;
													}
						...
						for (; k || m; ) {
							if (k && !m) {
								...
								if (f ? k.isBlockBoundary() : !h.contains(k)) break;
								(M && "inline" == k.getComputedStyle("display")) ||
									((M = !1), F ? (p = k) : k && this.setEndAfter(k));
								m = k.getNext();
							}
							for (; m; ) {
								A = !1;
					...
					case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
						...
						var u,
							S,
							T = CKEDITOR.dom.walker.blockBoundary(
						...
						k = new CKEDITOR.dom.walker(k);
						k.guard = a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? f : P;
						u = t = S = null;
						k = k.lastForward();
						u = u || h;
						this.setEndAt(
	...
	(function () {
		...
		a.prototype = {
			getNextParagraph: function (a) {
				...
				for (this._.nextNode = null; n; ) {
					...
					if (I) n.type == CKEDITOR.NODE_TEXT && g.test(n.getText()) && (I = 0);
						...
						if (
							...
							n.isBlockBoundary(this.forceBrBreak && !x && { br: 1 })
						) {
							if ("br" == m) I = 1;
					...
					if (l && !H)
						for (; !n.getNext(h) && !w; ) {
							m = n.getParent();
							if (m.isBlockBoundary(this.forceBrBreak && !x && { br: 1 })) {
								H = 1;
								I = 0;
								w || m.equals(q);
				...
				y &&
					...
					("br" == y.getName()
						? y.remove()
						: y.getLast() &&
						  "br" == y.getLast().$.nodeName.toLowerCase() &&
						  y.getLast().remove());
				G &&
					(y = d.getLast()) &&
					y.type == CKEDITOR.NODE_ELEMENT &&
					"br" == y.getName() &&
					(!CKEDITOR.env.needsBrFiller || y.getPrevious(f) || y.getNext(f)) &&
					y.remove();
				this._.nextNode ||
					(this._.nextNode =
						w || d.equals(q) || !q ? null : this._getNextSourceNode(d, 1, q));
				return d;
			},
			_getNextSourceNode: function (a, b, c) {
				...
				for (a = a.getNextSourceNode(b, null, d); !f(a); )
	...
	(function () {
		function a(a, b, c, d, f) {
			...
			for (e in b) {
				...
				for (r in S) {
					...
					for (P in h)
						"!" == P.charAt(0) &&
							((P = P.slice(1)), u.push(P), (n[P] = !0), (B = !1));
					for (; (P = u.pop()); ) (h[P] = h["!" + P]), delete h["!" + P];
					D[t] = (B ? !1 : n) || null;
				}
					...
					if (
						...
						if (a)
							if (!0 === a) a = !0;
								...
								for (var e = 0, g = c.length, m; e < g; ++e)
									(m = c[e]), f[m] || (f[m] = a(m));
								a = !1;
							}
						else a = !1;
		...
		function y(a, b, f, e) {
			...
			if (e.doFilter) {
				a: {
					t = b.name;
					D = a._;
					a = D.allowedRules.elements[t];
					r = D.allowedRules.generic;
					t = D.disallowedRules.elements[t];
					D = D.disallowedRules.generic;
					h = e.skipRequired;
					var l = {
							valid: !1,
							validAttributes: {},
					...
					if (a || r) {
						...
						if (D) for (u = 0, E = D.length; u < E; ++u) c(D[u], b, l);
						if (a) for (u = 0, E = a.length; u < E; ++u) d(a[u], b, l, h);
						if (r) for (u = 0, E = r.length; u < E; ++u) d(r[u], b, l, h);
						a = l;
					} else a = null;
				}
		...
		function K(a, b, c) {
			...
			if (r.$empty[d] || !a.children.length)
				...
				if ("br" == b)
					a.previous && !I(a.previous) && ((b = x()), b.insertBefore(a)),
						a.next && !I(a.next) && ((b = x()), b.insertAfter(a)),
		...
		function F(a, b) {
			...
			for (e in d)
				if ("class" == e)
					for (
						c = d[e].split(/\s+/), m = a.classes.join("|");
						(v = c.pop());
			...
			for (g in f) if (a.styles[g] != f[g]) return !1;
			return !0;
		}
		function M(a, b) {
			var c, d;
		...
		CKEDITOR.filter.prototype = {
			allow: function (b, c, d) {
				...
				if ("string" == typeof b) b = e(b);
					...
					d &&
						...
						delete d["class"],
						(g.attributes = d),
						(g.requiredAttributes = d && CKEDITOR.tools.object.keys(d)));
			...
			applyTo: function (a, b, c, d) {
				...
				for (; (D = a.pop()); )
					if (((c = D.el), c.parent))
						switch (((h = r[c.parent.name] || r.span), D.check)) {
							case "it":
			...
			check: function (a, b, c) {
				...
				if ("string" == typeof a) {
					...
					(f = a.getDefinition()),
						...
						v && !CKEDITOR.tools.isEmpty(v)
							? ((v = E(v)), (d.style = CKEDITOR.tools.writeCssText(v, !0)))
							: (v = {}),
						(f = {
							name: f.element,
							attributes: d,
				...
				if (!1 !== b && (r = this._.transformations[f.name])) {
					for (d = 0; d < r.length; ++d) m(this, f, r[d]);
					q(f);
				}
				y(this, v, t, {
					doFilter: !0,
				...
				0 < t.length
					...
					: ((b = f.attributes["class"]) &&
							(f.attributes["class"] = f.attributes["class"]
								...
								.sort()
								.join(" ")),
					  (c = CKEDITOR.tools.objectCompare(f.attributes, v.attributes, !0)),
			...
			transform: function (a, b) {
				if ("string" == typeof b) a.name = b;
					...
					for (e in f)
						if ("class" == e)
							for (
								c = a.classes.join("|"), m = f[e].split(/\s+/);
								(v = m.pop());
	...
	CKEDITOR.resourceManager.prototype = {
		...
		load: function (a, d, b) {
			...
			for (
				var c = this.loaded, g = this.registered, f = [], l = {}, h = {}, k = 0;
				k < a.length;
				k++
			) {
				var p = a[k];
						...
						a.call(
							...
							function (a) {
								...
								for (e in a) {
									...
									if (!d[e]) {
										if (h.icons)
											for (var y = h.icons.split(","), G = y.length; G--; )
	...
	(function () {
				...
				for (var g in b) {
					...
					l &&
						...
						m.langEntries && m.langEntries[k]
							? ((a.lang[g] = m.langEntries[k]), (k = null))
							: e.push(CKEDITOR.getUrl(m.path + "lang/" + k + ".js")));
					f.push(k);
					d.push(m);
				}
						...
						for (
							...
							for (var g = 0; g < d.length; g++) {
								...
								0 === e &&
									...
									m.lang &&
									m.langEntries &&
									(a.lang[m.name] = m.langEntries[f[g]]);
								if (m[b[e]]) m[b[e]](a);
							}
		...
		function y(a, b) {
			...
			for (
				var f = new CKEDITOR.dom.documentFragment(), e, g, h, l = 0;
				l < a.length;
				l++
			) {
				var k = a[l],
				...
				c(k)
					? (e ||
					  ...
					  (g && g.equals(r)) || ((g = r), (h = r.clone()), e.append(h)),
					  h.append(d(k)))
	...
	(function () {
		...
		CKEDITOR.htmlParser.fragment.fromHtml = function (f, l, h) {
			function k(a) {
				var b;
				if (0 < n.length)
					for (var c = 0; c < n.length; c++) {
						...
						(g && !g[f]) || (a && e && !e[a] && CKEDITOR.dtd[a])
							? f == x.name && (z(x, x.parent, 1), c--)
							: (b || (p(), (b = 1)),
							  (d = d.clone()),
							  (d.parent = x),
							  (x = d),
			...
			function z(b, c, d) {
				...
				var f = x;
				void 0 === b.previous &&
					(w(c, b) && ((x = c), G.onTagOpen(h, {}), (b.returnPoint = c = x)),
					e(b),
					(a(b) && !b.children.length) || c.add(b),
					"pre" == b.name && (K = !1),
					"textarea" == b.name && (I = !1));
				b.returnPoint
					? ((x = b.returnPoint), delete b.returnPoint)
					: (x = d ? c : f);
			}
			function w(a, b) {
				if (
				...
				if (a(e)) n.push(e);
					...
					if ("br" == f) H.push(e);
						...
						for (
							...
							!((h = (g = x.name)
								? CKEDITOR.dtd[g] ||
								  (x._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span)
								: c),
							e.isUnknown || x.isUnknown || h[f]);
							...
							if (x.isOptionalClose) G.onTagClose(g);
								...
								(g = x.children),
									((g = g[g.length - 1]) && "li" == g.name) ||
										z((g = new CKEDITOR.htmlParser.element("li")), x),
									!e.returnPoint && (e.returnPoint = x),
									(x = g);
							else if (f in CKEDITOR.dtd.$listItem && !y(f, g))
								G.onTagOpen("li" == f ? "ul" : "dl", {}, 0, 1);
							else if (g in d && !y(f, g))
								!e.returnPoint && (e.returnPoint = x), (x = x.parent);
							else if ((g in CKEDITOR.dtd.$inline && n.unshift(x), x.parent))
								z(x, x.parent, 1);
							else {
								e.isOrphan = 1;
								break;
			...
			G.onText = function (a) {
				if (
					!((x._.hasInlineStarted && !H.length) || K || I) &&
	...
	(function () {
		...
		a.prototype = {
			...
			addMany: function (a, c, d) {
				for (var f = [this.findIndex(c), 0], l = 0, h = a.length; l < h; l++)
					f.push({ value: a[l], priority: c, options: d });
			...
			execOnName: function (a, c) {
				for (var d = 0, f = this.rules, l = f.length, h; c && d < l; d++)
					(h = f[d]),
			...
			function r(a, b) {
				...
				return a.type == CKEDITOR.NODE_TEXT &&
					...
					(!CKEDITOR.env.needsBrFiller && h && (!b || a.parent.name in u)) ||
						(!h && (((c = a.previous) && "br" == c.name) || !c || f(c))))
					? !0
					: !1;
			}
			var D = { elements: {} },
			...
			return a.replace(r, function (a, b, c) {
				return (
					...
					c.replace(E, function (a, b) {
						return D.test(b) && -1 == c.indexOf("data-cke-saved-" + b)
		...
		function e(a, b) {
			return a.replace(b, function (a, b, c) {
				0 === a.indexOf("\x3ctextarea") &&
					(a =
						b +
						y(c).replace(/</g, "\x26lt;").replace(/>/g, "\x26gt;") +
						"\x3c/textarea\x3e");
				return (
			...
			b.on(
				...
				function (a) {
					...
					CKEDITOR.env.ie &&
						9 > CKEDITOR.env.version &&
						"pre" == f &&
						((f = "div"), (c = "\x3cpre\x3e" + c + "\x3c/pre\x3e"), (g = 1));
					...
					f &&
						((g = c),
						!g.children.length &&
							CKEDITOR.dtd[g.name][f] &&
							((f = new CKEDITOR.htmlParser.element(f)), g.add(f)));
					a.dataValue = c;
				},
				null,
				null,
	...
	(function () {
		...
		CKEDITOR.inlineAll = function () {
			...
			for (b in CKEDITOR.dtd.$editable)
				for (
					var c = CKEDITOR.document.getElementsByTag(b), g = 0, f = c.count();
					g < f;
					g++
				)
					(a = c.getItem(g)),
				...
				insertElementIntoRange: function (a, b) {
					...
					b.startContainer.type == CKEDITOR.NODE_ELEMENT &&
						(b.startContainer.is({
							...
							? H(b)
							: b.startContainer.is(CKEDITOR.dtd.$list) && x(b));
					var g, h;
					if (f)
						for (
							;
						...
						CKEDITOR.env.gecko &&
							this.attachListener(this, "mouseup", function (b) {
								if (
									2 == b.data.$.button &&
									((b = b.data.getTarget()),
									!b.getAscendant("table") && !b.getOuterHtml().replace(q, ""))
								) {
									var c = a.createRange();
		...
		n = (function () {
							  ...
							  A && g in CKEDITOR.dtd.$list
									...
									: ((h = !!l[g]),
									  "br" != g ||
											...
											(k && k != u - 1) ||
											((S =
												(f = k ? r[k - 1].node : E.getItem(k + 1)) &&
												(!a(f) || !f.is("br"))),
											(f = f && a(f) && D.$block[f.getName()])),
									  -1 != p || h || (p = k),
									  h || (n = k),
									  r.push({
											isElement: 1,
			...
			function f(b) {
				return (
					b &&
					a(b) &&
					(b.is(D.$removeEmpty) || (b.is("a") && !b.isBlockBoundary()))
				);
			}
			function g(b, c, d, e) {
				var f = b.clone(),
			...
			return function (t, u, J, v) {
				...
				if (!v.checkReadOnly()) {
					...
					for (; (G = e(C)) && a(G) && G.isBlockBoundary() && y.contains(G); )
						C.moveToPosition(G, CKEDITOR.POSITION_BEFORE_END);
					g(C, u.blockLimit, y, x);
					w && (C.setEndBefore(w), C.collapse(), w.remove());
					w = C.startPath();
					if ((q = w.contains(f, !1, 1)))
						(V = C.splitElement(q)),
							(u.inlineStylesRoot = q),
							(u.inlineStylesPeak = w.lastElement);
					w = C.createBookmark();
					L && (k(q), k(V));
					(q = w.startNode.getPrevious(c)) && a(q) && f(q) && z.push(q);
					(q = w.startNode.getNext(c)) && a(q) && f(q) && z.push(q);
					for (q = w.startNode; (q = q.getParent()) && f(q); ) z.push(q);
					C.moveToBookmark(w);
					...
					if ((t = J)) {
						...
						if ("text" == u.type && u.inlineStylesRoot) {
							...
							for (V = u.inlineStylesRoot.getParent(); !v.equals(V); )
					...
					if (t) {
						...
						for (E(B, Q); V < B.length; V++) {
							...
							if ((L = C.isLineBreak))
								(L = Q),
									...
									C.hasBlockSibling
										? (L = 1)
										: (y = L.startContainer.getAscendant(D.$block, 1)) &&
										  y.is({ div: 1, p: 1 })
										? ((x = y.getPosition(q)),
										  x == CKEDITOR.POSITION_IDENTICAL ||
										  x == CKEDITOR.POSITION_CONTAINS
												? (L = 0)
												: ((q = L.splitElement(y)),
												  L.moveToPosition(q, CKEDITOR.POSITION_AFTER_START),
												  (L = 1)))
										: (L = 0);
							if (L) J = 0 < V;
							else {
								L = Q.startPath();
								!C.isBlock &&
									l(u.editor, L.block, L.blockLimit) &&
									(O = h(u.editor)) &&
									((O = t.createElement(O)),
									O.appendBogus(),
									Q.insertNode(O),
								...
								if (w && C.isElement) {
									...
									if (L)
										...
										y = [];
										x = q.length;
										for (var aa = 0, ca = void 0, X = 0, W = -1; aa < x; aa++)
											(ca = q[aa]),
												" " == ca
													? (X ||
															(Z && !aa) ||
								...
								C.lastNotAllowed &&
									V < B.length - 1 &&
									((K = z ? G : K) &&
										Q.setEndAt(K, CKEDITOR.POSITION_AFTER_START),
									(w = 0));
								Q.collapse();
							}
						}
						...
						R &&
							((J = !0),
							(L = B[0].node),
							Q.setStartAt(L, CKEDITOR.POSITION_BEFORE_START),
							Q.setEndAt(L, CKEDITOR.POSITION_AFTER_END));
						u.dontMoveCaret = J;
					...
					for (I = R.createBookmark(); (O = u.zombies.pop()); )
						O.getParent() &&
							((K = R.clone()),
							K.moveToElementEditStart(O),
	...
	(function () {
		...
		CKEDITOR.on("instanceCreated", function (a) {
			...
			c.on("contentDom", function () {
				...
				k.attachListener(k, "keydown", G(c), null, null, -1);
			});
		...
		CKEDITOR.dom.selection.prototype = {
			...
			selectRanges: function (a) {
				...
				this.reset();
				if (c)
					for (var c = this.root, f, h = 0; h < a.length; ++h)
						(f = a[h]),
							f.endContainer.equals(c) &&
								(f.endOffset = Math.min(f.endOffset, c.getChildCount()));
				if (a.length)
					if (this.isLocked) {
	...
	(function () {
			...
			if (c.collapsed)
				...
				for (w.getPosition(r) == CKEDITOR.POSITION_FOLLOWING && (w = 0); w; ) {
					...
					if (w.equals(r)) (w = null), (k = !0);
						...
						if (
							(u && w.data("cke-bookmark")) ||
							w.type === CKEDITOR.NODE_COMMENT
						) {
						...
						if (y && m && CKEDITOR.dtd.$block[u])
							for (
								...
								if (M ? M.check(this) : 1)
									A.selectNodeContents(F), b.call(this, A);
							}
						...
						if (E)
							if (
								...
								(K = l),
								!F ||
									(!(F.getDtd() || CKEDITOR.dtd.span)[I] && !K) ||
								...
								if (
									(z ||
										(u &&
											...
											(w.getPosition(r) | S) != S) ||
										((z = c.clone()), z.setStartBefore(w)),
									(u = w.type),
									u == CKEDITOR.NODE_TEXT ||
										y ||
										(u == CKEDITOR.NODE_ELEMENT && !w.getChildCount()))
								) {
									for (
										var u = w, N;
										(k = !u.getNext(D)) &&
										((N = u.getParent()), p[N.getName()]) &&
										d(N, q, h, T);
						...
						for (
							...
							if (x.getName() == f) {
								for (X in h.attributes)
									!I[X] &&
										(Y = x.getAttribute(W)) &&
										(k.getAttribute(X) == Y ? (E[X] = 1) : (I[X] = 1));
								for (W in h.styles)
									!F[W] &&
										(Y = x.getStyle(W)) &&
										(k.getStyle(W) == Y ? (u[W] = 1) : (F[W] = 1));
							}
							x = x.getParent();
						}
		...
		function G(a) {
			for (
				...
				(d = c.getItem(e)), d.isReadOnly() || y.call(this, d, !0);
			for (var f in b)
				if (f != this.element)
			...
			_: {
				...
				hslToRgb: function (a, b, c) {
					var d = function (d) {
						...
						e = Math.max(-1, e);
						return Math.round(
							(c - d * e) * CKEDITOR.tools.color.MAX_RGB_CHANNEL_VALUE
						);
					};
					return [d(0), d(8), d(4)];
				},
	...
	CKEDITOR.tools.extend(CKEDITOR.dom.text.prototype, {
		...
		split: function (a) {
			...
			d.childNodes.length == b &&
				(a >= c
					? ((f = g.createText("")), f.insertAfter(this))
					: ((a = g.createText("")), a.insertAfter(f), a.remove()));
			return f;
		},
			...
			setUiColor: function (a) {
				...
				return (this.setUiColor = function (a) {
					...
					var c = CKEDITOR.skin.chameleon,
						...
						f = "";
					"function" == typeof c &&
						((d = c(this, "editor")), (f = c(this, "panel")));
					a = [[k, a]];
					g([b], d, a);
					g(h, f, a);
				}).call(this, a);
